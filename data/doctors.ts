...
export const DOCTORS: Doctor[] = [
  ...
  },
  {
    ...
    "name": "Karishma Afrin OT",
    "namebn": "কারিশমা আফরিন ও.টি",
    "title": "BSOT (BHPI-CRP). Medicine Faculty (DU)",
    "titlebn": "বি.এস.ও.টি (বিএইচপিআই-সিআরপি), মেডিসিন ফ্যাকাল্টি (ঢাবি)",
    "specialties": ["Occupation Therapist"],
    "specialtiesbn": ["অকুপেশন থেরাপিস্ট"],
    "bio": "Specialist in Occupation Therapy. Consultant in the Occupational Therapy Department with a focus on musculoskeletal assessment and rehabilitation.",
    "biobn": "অকুপেশন থেরাপিতে বিশেষজ্ঞ। মাস্কিউলোস্কেলেটাল মূল্যায়ন ও পুনর্বাসনে অভিজ্ঞ অকুপেশন থেরাপি বিভাগের কনসালট্যান্ট।",
